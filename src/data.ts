...
export const PROJECTS: Project[] = [
  {
    id: 'VIP-COMPUTER-',
    title: 'VIP Computer Portal',
    description: 'A high-speed premium hardware portal, customized checkout systems, secure administrator panels, and real-time inventory dashboards.',
    category: 'Full-Stack / Systems',
    tech: ['React', 'Express', 'MongoDB', 'Tailwind CSS', 'Stripe API'],
    githubUrl: 'https://github.com/Niketraj08/VIP-COMPUTER-',
    liveUrl: 'https://github.com/Niketraj08/VIP-COMPUTER-',
    metric: 'Enterprise E-Commerce',
  },
  {
    id: 'one-bharat-mission-',
    title: 'One Bharat Mission',
    description: 'A collaborative national community platform supporting local aid synchronization, public development metrics, and integrated chat channels.',
    category: 'Full-Stack / Systems',
    tech: ['Node.js', 'Express', 'MongoDB', 'JavaScript', 'HTML5'],
    githubUrl: 'https://github.com/Niketraj08/one-bharat-mission-',
    liveUrl: 'https://github.com/Niketraj08/one-bharat-mission-',
    metric: 'Social Impact Platform',
  },
  {
    id: 'SmartAgri_village',
    title: 'Smart Agri Village',
    description: 'An automated agricultural telemetry interface mapping real-time soil moisture values, predictive crop yields, and atmospheric weather updates.',
    category: 'AI & Tools',
    tech: ['Python', 'React', 'Chart.js', 'HTML5', 'IoT Integrations'],
    githubUrl: 'https://github.com/Niketraj08/SmartAgri_village',
    liveUrl: 'https://github.com/Niketraj08/SmartAgri_village',
    metric: 'Smart Farming IoT',
  },
  {
    id: 'Chessgame-in-java-',
    title: 'Java Multiplayer Chess',
    description: 'A secure client-server multiplayer chess suite featuring full move validation logic, interactive game boards, timer loops, and persistent statistics.',
    category: 'Full-Stack / Systems',
    tech: ['Java', 'Swing', 'Socket Programming', 'OOP Principles', 'Multi-threading'],
    githubUrl: 'https://github.com/Niketraj08/Chessgame-in-java-',
    liveUrl: 'https://github.com/Niketraj08/Chessgame-in-java-',
    metric: 'Real-Time Game State',
  },
  {
    id: 'Smart-Campus-school-website-final-touch-',
    title: 'Smart Campus Platform',
    description: 'A highly polished school workspace and student-parent dashboard featuring modern dynamic components, animated schedules, and academic portals.',
    category: '3D / UI',
    tech: ['HTML5', 'CSS3', 'JavaScript', 'PHP', 'MySQL'],
    githubUrl: 'https://github.com/Niketraj08/Smart-Campus-school-website-final-touch-',
    liveUrl: 'https://github.com/Niketraj08/Smart-Campus-school-website-final-touch-',
    metric: 'Campus Digital Workspace',
  },
  {
    id: 'AstraCognix-AI',
